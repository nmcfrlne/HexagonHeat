...
public class CameraManager : MonoBehaviour {
	...
	[SerializeField] private Transform target; //Player the camera follows

	[SerializeField] private Transform pivot; //Pivot on which the camera rotates(distance that we want between the camera and our character)
	[SerializeField] private Transform camTrans; //Camera position
